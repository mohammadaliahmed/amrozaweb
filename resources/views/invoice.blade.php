                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <th>
                                ...
                                Name: {{$invoice['order']['customer']['name']}}<br>
                                Phone: {{$invoice['order']['customer']['phone']}}<br>
                                Address: {{$invoice['order']['customer']['address']}}<br>
                                Store Name: {{$invoice['order']['customer']['storeName']}}
                                <br>
                                Store Type: {{$invoice['order']['customer']['storeType']}}
                                <br>
